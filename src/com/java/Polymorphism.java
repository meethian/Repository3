package com.java;
public class Polymorphism {//parent class
...
System.out.println("Doctor Name:Dr.Mugesh; Patient Nmame:"
...
srm1.srmHospital();
srm1.customer("Mr.Mumar", 102486l);
srm1.feedetails(1000,"Depends");
}
}
